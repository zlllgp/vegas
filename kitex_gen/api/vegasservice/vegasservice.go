...
var (
	vegasServiceServiceInfo                = NewServiceInfo()
	vegasServiceServiceInfoForClient       = NewServiceInfoForClient()
	vegasServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return vegasServiceServiceInfo
}

// for stream client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return vegasServiceServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return vegasServiceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "VegasService"
	handlerType := (*api.VegasService)(nil)
...
func drawHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.VegasService).Draw(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DrawArgs:
		success, err := handler.(api.VegasService).Draw(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *DrawResult) GetSuccess() *api.DrawResponse {
	if !p.IsSetSuccess() {
...
func showHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(api.ShowRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(api.VegasService).Show(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ShowArgs:
		success, err := handler.(api.VegasService).Show(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*ShowResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newShowArgs() interface{} {
	return &ShowArgs{}
}

func newShowResult() interface{} {
	return &ShowResult{}
}
...
func (p *ShowArgs) Unmarshal(in []byte) error {
	msg := new(api.ShowRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ShowArgs_Req_DEFAULT *api.ShowRequest

func (p *ShowArgs) GetReq() *api.ShowRequest {
	if !p.IsSetReq() {
		return ShowArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ShowArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ShowArgs) GetFirstArgument() interface{} {
	return p.Req
}

type ShowResult struct {
	Success *api.ShowResponse
}
...
func (p *ShowResult) Unmarshal(in []byte) error {
	msg := new(api.ShowResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ShowResult) GetSuccess() *api.ShowResponse {
	if !p.IsSetSuccess() {
		return ShowResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ShowResult) SetSuccess(x interface{}) {
	p.Success = x.(*api.ShowResponse)
}

func (p *ShowResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ShowResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) Draw(ctx context.Context, Req *api.DrawRequest) (r *api.DrawResponse, err error) {
	var _args DrawArgs
	_args.Req = Req
...
func (p *kClient) Show(ctx context.Context, Req *api.ShowRequest) (r *api.ShowResponse, err error) {
	var _args ShowArgs
	_args.Req = Req
	var _result ShowResult
	if err = p.c.Call(ctx, "Show", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
