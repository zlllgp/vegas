...
func NewSearchFiled(field StringField, fieldName string, operator api.SearchOperator) *SearchField {
	return &SearchField{
		Field:     field,
		FieldName: fieldName,
		Operator:  operator,
...
func (t *SearchField) ToGormCondition(value string) (gen.Condition, error) {
	switch t.Operator {
