...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		RuleMetum: newRuleMetum(db, opts...),
	}
}
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		RuleMetum: q.RuleMetum.clone(db),
	}
}
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		RuleMetum: q.RuleMetum.replaceDB(db),
	}
}
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		RuleMetum: q.RuleMetum.WithContext(ctx),
	}
}
